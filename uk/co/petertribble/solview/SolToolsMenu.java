...
import uk.co.petertribble.solview.helpers.RunInXterm;
import java.util.*;
import java.io.File;

/**
 * SolToolsMenu - standard toolbar menu for solview tools.
...
public class SolToolsMenu extends JMenu implements ActionListener {
     ...
     */
    public SolToolsMenu() {
	super(SolViewResources.getString("TOOLS.TEXT"));
	setMnemonic(KeyEvent.VK_T);

	addItem("Top", "/usr/local/bin/top", (String) null);
	addItem("Top", "/usr/bin/top", (String) null);
	addItem("Top", "/opt/sfw/bin/top", (String) null);
