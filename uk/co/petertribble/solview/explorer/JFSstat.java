...
public class JFSstat extends JKdemo implements ActionListener {
	...
	JMenu displayMenu = new JMenu(SolViewResources.getString(
						"FSSTAT.DISPLAY.TEXT"));
	...
	JMenu showMenu = new JMenu(SolViewResources.getString(
						"FSSTAT.SHOW.TEXT"));
	showMenu.setMnemonic(KeyEvent.VK_S);
	hiddenItem = new JCheckBoxMenuItem(SolViewResources.getString(
					"FSSTAT.HIDDEN.TEXT"), false);
	hiddenItem.addActionListener(this);
	showMenu.add(hiddenItem);
	aggrItem = new JCheckBoxMenuItem(SolViewResources.getString(
