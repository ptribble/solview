...
public class SmfInfoPanel extends JPanel {
	...
	jtp.add(SolViewResources.getString("SMF.STATUS"), jsp);

	dtp = new JingleTextPane();
	jtp.add(SolViewResources.getString("SMF.DEPS"), new JScrollPane(dtp));

	tpl = new JingleTextPane();
	jtp.add(SolViewResources.getString("SMF.LOG"), new JScrollPane(tpl));
